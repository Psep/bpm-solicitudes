...
<div id="container">
	<div id="header">
		User Task Form: Solicitud.GenerarDevolucion
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">Devol_idSolicitud</label>
                            		<div class="div_checkbox">
                              		${Devol_idSolicitud}
                            		</div>
                            		<label for="name">Devol_usuario</label>
                            		<div class="div_checkbox">
                              		${Devol_usuario}
                            		</div>
                            		<label for="name">Devol_nombreUsuario</label>
                            		<div class="div_checkbox">
                              		${Devol_nombreUsuario}
                            		</div>
